...
rem python "c:\Users\kalvis.apsitis\AppData\Local\Google\Cloud SDK\google-cloud-sdk\bin\dev_appserver.py" c:\Users\kalvis.apsitis\workspace\linen-tracer-682
