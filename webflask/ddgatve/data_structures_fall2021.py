...
bp = Blueprint('data_structures_fall2021', __name__, url_prefix='/data-structures-fall2021')
...
def index():
    ...
    return render_template('data_structures_fall2021/index.html', **template_context)
...
def assignments():
    ...
    return render_template('data_structures_fall2021/assignments.html', **template_context)
...
def slides():
    ...
    return render_template('data_structures_fall2021/slides.html', **template_context)
...
def algorithms():
    ...
    return render_template('data_structures_fall2021/algorithms.html', **template_context)
...
def submissions():
    ...
    return render_template('data_structures_fall2021/submissions.html', **template_context)
