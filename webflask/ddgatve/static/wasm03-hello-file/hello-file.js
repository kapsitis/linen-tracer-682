...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'hello-file.data';
      var REMOTE_PACKAGE_BASE = 'hello-file.data';
...
Module['FS_createPath']("/", "tests", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_hello-file.data');

      };
      Module['addRunDependency']('datafile_hello-file.data');
    ...
    loadPackage({"files": [{"filename": "/tests/hello_world_file.txt", "start": 0, "end": 199}], "remote_package_size": 199, "package_uuid": "1efc2ffb-cc0b-486a-926a-c0ca42ee0f35"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'hello-file.wasm';
